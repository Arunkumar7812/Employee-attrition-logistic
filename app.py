...
# IMPORTANT: This list must exactly match the columns (including all one-hot encoded
# features and the order) that your logistic regression model was trained on.
REQUIRED_COLS = [
...
if st.button("Predict Attrition Risk"):
    ...
    input_data = {
        ...
        # Only include the specific JobRoles used in REQUIRED_COLS
    }
    ...
    # It is critical that the input features match the training features exactly.
    try:
